          ...
          {values.map(({ icon: Icon, title, text }, i) => (
            <Reveal key={title} delay={i * 0.12} className="h-full">
              <div className="group card-interactive h-full p-7 sm:p-8 text-center">
                <div className="h-16 w-16 rounded-2xl bg-brand-soft group-hover:bg-brand flex items-center justify-center text-brand-ink group-hover:text-on-brand mx-auto mb-5 transition-all duration-300 sh-soft group-hover:rotate-[-6deg] group-hover:scale-110">
                  <Icon size={28} />
                </div>
