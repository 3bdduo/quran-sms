 ...
 *
 * ملاحظات الأداء (موبايل):
 *  • will-change: transform على الكرة عشان الـ GPU يحجز layer مسبقًا
 *  • touch-action: manipulation عشان يلغي تأخير الـ 300ms في iOS/Android
 *  • durations أقصر بكتير عشان الاستجابة تبدو فورية
 */
export function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="absolute inset-0 bg-linear-to-br from-[#f3efc4] via-[#cfe0ad] to-[#8fb77f] opacity-100 dark:opacity-0 transition-opacity duration-300"
      >
      ...
      <span
        aria-hidden="true"
        className="absolute inset-0 bg-linear-to-br from-[#2b2119] via-[#17110d] to-[#0a0806] opacity-0 dark:opacity-100 transition-opacity duration-300"
      >
        <i className="absolute left-[12%] top-[26%] h-[3px] w-[3px] rounded-full bg-[#f5e6c8] shadow-[0_0_2px_#fff]" />
        <i className="absolute left-[24%] top-[62%] h-[2px] w-[2px] rounded-full bg-white shadow-[0_0_2px_#fff]" />
        <i className="absolute left-[34%] top-[22%] h-[2px] w-[2px] rounded-full bg-white shadow-[0_0_2px_#fff]" />
        <i className="absolute left-[18%] top-[44%] h-[2px] w-[2px] rounded-full bg-[#f5e6c8] shadow-[0_0_2px_#fff]" />
        <i className="absolute left-[40%] top-[70%] h-[3px] w-[3px] rounded-full bg-white shadow-[0_0_2px_#fff]" />
      </span>
      ...
      >
        ...
        <span
          className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_35%_30%,#fff3b8,#f5c344_55%,#d99a1c)]
            shadow-[0_0_0_3px_rgba(245,195,68,0.28),0_0_12px_2px_rgba(245,195,68,0.65)]
        ...
        <span
          className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_35%_30%,#fffaf0,#e8dcc6_60%,#bfae92)]
            shadow-[0_0_10px_2px_rgba(240,225,195,0.35),inset_-3px_-3px_5px_rgba(120,100,70,0.35)]
