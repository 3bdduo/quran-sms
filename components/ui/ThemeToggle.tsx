  ...
  return (
    <button
      ...
      className={`group relative h-9 w-[68px] sm:h-10 sm:w-[76px] shrink-0 overflow-hidden rounded-full
        ...
        transition-transform duration-[1000ms] hover:scale-105 active:scale-95 ${className}`}
    >
      {/* سما النهار */}
      <span
        aria-hidden="true"
        className="absolute inset-0 bg-linear-to-br from-[#f3efc4] via-[#cfe0ad] to-[#8fb77f] opacity-100 dark:opacity-0 transition-opacity duration-[1600ms]"
      >
      ...
      <span
        aria-hidden="true"
        className="absolute inset-0 bg-linear-to-br from-[#2b2119] via-[#17110d] to-[#0a0806] opacity-0 dark:opacity-100 transition-opacity duration-[1600ms]"
      >
      ...
      <span
        ...
        className="absolute left-1 top-1 h-7 w-7 sm:h-8 sm:w-8 rounded-full
          ...
          transition-transform duration-[1400ms] ease-[cubic-bezier(0.34,1.56,0.64,1)]"
      >
        {/* الشمس */}
        <span
